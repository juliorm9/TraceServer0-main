...
public class TraceServerApplication {
	...
	public TraceServerApplication(TraceRepository tr, String traceId, String truck, long lastSeen,
	double lat, double lng) {

		this.traceRepository = tr;
	...
	public Consumer<Trace> checkTrace() {
                ...
                return t -> {
                        ...
                        if (result != null && result.getSt() == 0) {
                                ...
                                restTemplate.put("http://localhost:8080/transportationorders/", result, 
